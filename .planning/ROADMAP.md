...
**Plans:** 6 plans
Plans:
- [ ] 07-01-PLAN.md -- Foundation tokens + focus-visible + simple migrations (AdminUsers, RequireAdmin, App.jsx)
...
- [ ] 07-04-PLAN.md -- Tooltip + StatusBar shared UI components
...
| 7. Component Migration + Accessibility | v2.0.0 | 0/6 | In Progress | - |
